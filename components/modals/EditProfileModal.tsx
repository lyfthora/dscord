...
export default function EditProfileModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setUploadError(null);
    let avatarUrl = (user.publicMetadata?.imageUrl as string) || user.imageUrl;
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-gray-700 bg-gray-200 dark:bg-gray-600 dark:text-gray-200 rounded-md"
            >
              Cancel
            </button>
            <button
