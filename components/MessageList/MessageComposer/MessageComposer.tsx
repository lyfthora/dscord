...
export default function MessageComposer(): JSX.Element {
  ...
  return (
    <div className="flex mx-6 my-6 px-4 py-1 bg-composer-gray dark:bg-[var(--hover-dark-gray)] border dark:border-[var(--border-color-chat)]  items-center justify-center space-x-4 rounded-md text-gray-600 dark:text-gray-400 relative">
      ...
      {plusMenuOpen && (
        <div className="absolute p-2 z-10 -left-6 bottom-12">
          <div className="bg-white dark:bg-[var(--hover-dark-gray)] p-2 shadow-lg rounded-md w-40 flex flex-col">
